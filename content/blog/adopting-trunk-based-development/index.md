...
This story may sound familiar. For me, it does!
...
<!-- Remove Abe for public release -->
Our proprietary A/B testing software Abe offers APIs to safely test code in production to get quick feedback and test new features with smaller groups of users. Abe takes a more personal approach within the organization, allowing users to target specific customers (even specific users) registered in WAM.
<!-- Remove Abe for public release -->
